...
@interface BOBTableKeyboardUtil : NSObject<KeyboardUtilProtocol>
//Block
...
typedef void (^printKeyboardInfoBlock)(BOBTableKeyboardUtil *keyboardUtil, KeyboardInfo *keyboardInfo);
typedef void (^animateWhenKeyboardAppearAutomaticAnimBlock)(BOBTableKeyboardUtil *keyboardUtil);
